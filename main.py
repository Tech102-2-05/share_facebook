...
import threading
import time
import json,requests,time # type: ignore
from time import strftime
from pystyle import Colorate, Colors, Write, Add, Center # type: ignore
__Copyright__ = 'open-source' '\033[1;91m[\033[1;92m●\033[1;91m]\033[1;97m ➻❥'  
def banner():
    print(f'''
\033[1;92m
███████╗██╗  ██╗ █████╗ ██████╗ ███████╗
...
def main_share():
    ...
    delay_input = input("\033[1;31m[\033[1;37m\033[1;31m] \033[1;37m=> \033[1m\033[38;5;51mNhập Delay Share (giây): \033[1;35m")
    delay = float(delay_input.replace(',', '.'))
